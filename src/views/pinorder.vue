<template>
    <div class="pinorder">
        ...
        <div class="nav flex ali_center flex_around">
            ...
            <div class="item" :class="{on:status == 1}" @click="changenav(1)">拼团中</div>
             ...
             <van-list
                ...
                <div
                    ...
                    <div class="flex ali_center flex_between id_status" v-if="item.status == 0">
                        <span class="order_sn">订单号： {{item.orderno}}</span>
                        <span class="status" v-if="item.status == 1">拼团中</span>
                        <span class="status" v-if="item.status == 2">中奖</span>
                        <span class="status" v-if="item.status == 3">未中奖</span>
                    </div>
                    <div>
                        ...
                        <div class="bottom flex ali_center " style="justify-content:flex-end;">
                            <div class="left">总价<span>{{item.price}}</span>FC</div>
                            <!-- <div class="right flex ali_center" style="margin-right:10px">
                                <span>取消订单</span>
                            </div> -->
                            <div class="right flex ali_center" @click="toporderdetail(item.id)" >
                                <span style="border:1px solid #da428d;color:#da428d;">查看订单</span>
                            </div>
                        </div>
                    </div>
                </div>
